    ...
    >
      ...
      <div className="overflow-auto py-6 h-full \">
        <ul className="space-y-1">
          <li>
            <button
              className="text-black hover:text-blue-600 text-[15px] flex items-center hover:bg-white rounded px-4 py-3 transition-all cursor-pointer w-full"
            >
              <Link className="flex" to={'/inventory'}>
              
              <svg
               className="w-[36px] h-[24px] "  fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M21 7v11.6c0 1.33-1.07 2.4-2.4 2.4H5.4C4.07 21 3 19.93 3 18.6V7" fill="#000000" fillOpacity=".16"/><path d="M21 7v11.6c0 1.33-1.07 2.4-2.4 2.4H5.4C4.07 21 3 19.93 3 18.6V7" stroke="#000000" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round"/><path d="M21.4 3H2.6A1.6 1.6 0 0 0 1 4.6v.8A1.6 1.6 0 0 0 2.6 7h18.8A1.6 1.6 0 0 0 23 5.4v-.8A1.6 1.6 0 0 0 21.4 3Z" fill="#ffffff" stroke="#000000" strokeWidth="1.5" strokeMiterlimit="10"/><path d="M8 11h8" stroke="#000000" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round"/>
          ...
          <li>
            <button
              ...
              className="text-black hover:text-blue-600 text-[15px] flex items-center hover:bg-white rounded px-4 py-3 transition-all w-full"
            >
