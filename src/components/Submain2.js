  ...
  return (
    <div className="mb-40">
      <div className="w-full flex justify-center mt-20 ">
        <div className="w-3/4">
          <h1
            className={` text-5xl md:text-8xl font-bold open-sans-main text-center text-slate-800 leading-tight transition-opacity duration-1000 ${
      ...
      <div className="w-full flex justify-center mt-10">
        <h1
          className={` text-xl md:text-2xl font-poppins open-sans-main text-center text-slate-400 leading-snug w-1/2 transition-opacity duration-1000 ${
            isVisible ? "opacity-100" : "opacity-0"
          }`}
        >
