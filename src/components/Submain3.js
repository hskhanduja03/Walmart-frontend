...
<div className={` container mx-auto p-20transition-opacity duration-1000 ${
  ...
  <div className="flex items-center flex-wrap  mb-10">
    ...
    <div className="w-full md:w-1/2 ml-auto  items-center ">

        <h1 className='text-dr text-5xl font-bold mb-5'>Data-Driven Insights</h1>
        <p className='text-xl text-gray-500 mb-2  ' >Identify Your Best Performers with Top Seller Insights.</p>

    </div>

  </div>

  <div className="flex  flex-wrap mb-20 mt-32 items-center ">

    <div className="w-full max-w-xl md:w-1/2 ml-auto mb-14 ">

        <h1 className='text-dr text-5xl font-bold mb-5'>Low Stock Alerts</h1>
        <p className='text-xl text-gray-500' >Notifications when inventory dips below a set threshold, preventing stockouts and lost sales.</p>
