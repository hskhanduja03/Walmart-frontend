      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 grid-cols-1">
                        ...
                        <div className="absolute bottom-0 w-full lg:p-11 p-5">
                            <div className="bg-white rounded-lg p-6 block">
                                ...
                                <a href="/" className="flex items-center mb-6">
                                    ...
                                    <h5 className="text-black text-base font-normal leading-6 ml-5">walmart1234@gmail.com</h5>
                                </a>
                                <a href="/" className="flex items-center">
                                    ...
                                    <h5 className="text-black text-base font-normal leading-6 ml-5">654 IIIT Kota Ranpur,Kota , 325003</h5>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                ...
                <textarea type="text" className="w-full h-20 text-gray-600 placeholder-gray-400 bg-transparent text-lg shadow-sm font-normal leading-7 border rounded-md border-gray-200 focus:outline-none pl-4 mb-10" placeholder="Message"/>
                <button className="w-full h-12 text-white text-base font-semibold leading-6 rounded-full transition-all duration-700 bg-cyan-500 border-0 py-1 px-3 focus:outline-none hover:bg-fuchsia-500 shadow-sm">Send</button>
        </div>
      </div>
      </div>
    </section>
